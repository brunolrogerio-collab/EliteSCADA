...
/// <summary>
/// Compiles canonical Engineering for exactly one supported DriverType. The
/// central compiler can dispatch enabled external Data Sources through these
/// planners instead of growing a protocol switch.
/// </summary>
...
/// <summary>
/// Host-owned services available while instantiating one external communication
/// runtime. Protected material is resolved only through explicit scoped
/// references; factories must not receive plaintext credentials in plans.
/// </summary>
...
/// <summary>
/// Creates the concrete runtime for one matching compiled plan. The factory may
/// select an implementation library internally; public plan identity remains
...
/// <summary>
/// Registry-ready pairing of planner and factory for one DriverType. This is a
/// host composition seam only; it does not replace the public module descriptor
/// / Engineering capability registration.
/// </summary>
...
/// <summary>
/// Fail-closed runtime component registry. Duplicate DriverTypes are rejected;
/// there is no ordering-dependent override behavior.
/// </summary>
