...
public static class BuiltinDynamoLibrary
{
    ...
    [
        ...
        [
            ...
            StateLamp(4, "running", 4, 4, "#22C55E", "{equipmentPath}.Running"),
            StateLamp(5, "fault", 104, 4, "#EF4444", "{equipmentPath}.Fault")
        ], "pump.standard"),
        ...
        [
            ...
            StateLamp(13, "running", 6, 5, "#22C55E", "{equipmentPath}.Running"),
            StateLamp(14, "fault", 70, 5, "#EF4444", "{equipmentPath}.Fault")
        ]),
        ...
        [
            ...
            StateLamp(22, "running", 4, 4, "#22C55E", "{equipmentPath}.Running"),
            StateLamp(23, "fault", 82, 4, "#EF4444", "{equipmentPath}.Fault")
        ]),
        ...
        [
            ...
            StateLamp(34, "running", 4, 4, "#22C55E", "{equipmentPath}.Running"),
            StateLamp(35, "fault", 114, 4, "#EF4444", "{equipmentPath}.Fault")
        ]),
        ...
        [
            ...
            StateLamp(43, "open", 5, 5, "#22C55E", "{equipmentPath}.Open"),
            StateLamp(44, "fault", 104, 5, "#EF4444", "{equipmentPath}.Fault")
        ]),
        ...
        [
            ...
            StateLamp(55, "fault", 104, 5, "#EF4444", "{equipmentPath}.Fault")
        ]),
        ...
        [
            ...
            StateLamp(63, "high", 84, 10, "#F59E0B", "{equipmentPath}.High"),
            StateLamp(64, "fault", 84, 132, "#EF4444", "{equipmentPath}.Fault")
        ]),
        ...
        [
            ...
            StateLamp(73, "high", 144, 10, "#F59E0B", "{equipmentPath}.High"),
            StateLamp(74, "fault", 144, 74, "#EF4444", "{equipmentPath}.Fault")
        ])
    ];
        ...
        new(
            ...
            [
                new EngineeringBindingDto(
                    ...
                    target,
                    "read",
                    Metadata: new Dictionary<string, string> { ["dynamoContext"] = "equipmentPath" })
            ],
            Properties: Properties(
