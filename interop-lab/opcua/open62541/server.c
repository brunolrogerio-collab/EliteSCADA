...
static UA_StatusCode addDoubleVariable(UA_Server *server, const char *nodeName, const char *displayName,
...
static UA_StatusCode addInt32Variable(UA_Server *server, const char *nodeName, const char *displayName,
...
static UA_StatusCode addBooleanVariable(UA_Server *server, const char *nodeName, const char *displayName,
...
static UA_StatusCode addStringVariable(UA_Server *server, const char *nodeName, const char *displayName,
...
static int ensureGood(const char *operation, UA_StatusCode status) {
...
int main(void) {
    ...
    int ok = 1;
    ok &= ensureGood("add Lab.Temperature", addDoubleVariable(server, "Lab.Temperature", "Lab Temperature", 21.5));
    ok &= ensureGood("add Lab.Counter", addInt32Variable(server, "Lab.Counter", "Lab Counter", 0));
    ok &= ensureGood("add Lab.Active", addBooleanVariable(server, "Lab.Active", "Lab Active", true));
    ok &= ensureGood("add Lab.MachineName", addStringVariable(server, "Lab.MachineName", "Lab Machine Name", "EliteSCADA Lab"));
