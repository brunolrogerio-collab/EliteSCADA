...
{
    // Decorate the persistence route group once so lifecycle authorization/audit,
    // public request validation and mutable-Working concurrency controls cannot be
    // accidentally omitted by individual persistence endpoint mappings.
    public static RouteGroupBuilder MapGroup(this WebApplication app, string prefix)
    {
        ...
        group.AddEndpointFilter<EngineeringPersistenceRequestValidationFilter>();
