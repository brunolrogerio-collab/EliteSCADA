...
/**
 * Explicit fallback used only when no persisted Engineering Runtime is active.
 * It preserves the existing owner-testable simulation surface without allowing
 * that hand-authored UI to masquerade as canonical Active Engineering.
 */
export function SimulationRuntimeApp() {
  ...
  return (
    <main className="shell" data-testid="runtime-simulation-fallback">
      <header className="topbar">
        <div>
          <strong>SCADA Platform</strong>
          <span>Runtime 0.1-dev · Simulation fallback</span>
        </div>
