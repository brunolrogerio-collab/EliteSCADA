...
const COMMON_VISUAL_PROPERTY_DEFINITIONS: readonly VisualPropertyDefinition[] = [
  ...
  enumProperty(VISUAL_PROPERTY_KEYS.fillStyle, 'solid', ['none', 'solid', 'gradient'], 'appearance'),
  ...
  colorProperty(VISUAL_PROPERTY_KEYS.shadowColor, '#00000066', 'appearance'),
  numberProperty(VISUAL_PROPERTY_KEYS.shadowOffsetX, 0, { animatable: true, unit: 'px', category: 'appearance' }),
  numberProperty(VISUAL_PROPERTY_KEYS.shadowOffsetY, 0, { animatable: true, unit: 'px', category: 'appearance' }),
  numberProperty(VISUAL_PROPERTY_KEYS.shadowBlur, 0, { minimum: 0, animatable: true, unit: 'px', category: 'appearance' }),
