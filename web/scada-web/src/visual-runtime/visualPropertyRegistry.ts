...
const COMMON_VISUAL_PROPERTY_DEFINITIONS: readonly VisualPropertyDefinition[] = [
  ...
  booleanProperty(VISUAL_PROPERTY_KEYS.horizontalFlip, false, 'geometry'),
  booleanProperty(VISUAL_PROPERTY_KEYS.verticalFlip, false, 'geometry'),
  ...
  booleanProperty(VISUAL_PROPERTY_KEYS.enabled, true, 'appearance'),
  numberProperty(VISUAL_PROPERTY_KEYS.opacity, 1, { minimum: 0, maximum: 1, animatable: true, category: 'appearance' }),
  stringProperty(VISUAL_PROPERTY_KEYS.tooltip, '', 'appearance'),
  enumProperty(VISUAL_PROPERTY_KEYS.fillStyle, 'solid', ['none', 'solid', 'linearGradient'], 'appearance'),
  colorProperty(VISUAL_PROPERTY_KEYS.fillColor, '#00000000', 'appearance'),
  colorProperty(VISUAL_PROPERTY_KEYS.fillSecondaryColor, '#00000000', 'appearance'),
  enumProperty(
    VISUAL_PROPERTY_KEYS.gradientDirection,
    'topToBottom',
    ['leftToRight', 'rightToLeft', 'topToBottom', 'bottomToTop', 'topLeftToBottomRight', 'topRightToBottomLeft'],
    'appearance'
  ),
  ...
  booleanProperty(VISUAL_PROPERTY_KEYS.shadowEnabled, false, 'appearance'),
  colorProperty(VISUAL_PROPERTY_KEYS.shadowColor, '#00000080', 'appearance'),
  numberProperty(VISUAL_PROPERTY_KEYS.shadowOffsetX, 2, { animatable: true, unit: 'px', category: 'appearance' }),
  numberProperty(VISUAL_PROPERTY_KEYS.shadowOffsetY, 2, { animatable: true, unit: 'px', category: 'appearance' }),
  numberProperty(VISUAL_PROPERTY_KEYS.shadowBlur, 4, { minimum: 0, animatable: true, unit: 'px', category: 'appearance' }),
  ...
  booleanProperty(VISUAL_PROPERTY_KEYS.underline, false, 'text'),
  booleanProperty(VISUAL_PROPERTY_KEYS.textWrap, true, 'text'),
  numberProperty(VISUAL_PROPERTY_KEYS.lineHeight, 1.2, { minimum: 0.1, maximum: 10, category: 'text' }),
  enumProperty(VISUAL_PROPERTY_KEYS.textOverflow, 'clip', ['clip', 'ellipsis'], 'text'),
