...
export function scriptWorkspaceCopy(locale: EngineeringLocale) {
  const copies = {
    'pt-BR': {
      ...
      subtitle: 'Scripts canônicos versionados com edição Python em Monaco. A execução pertence ao sandbox integrado da Wave 06, não ao editor.',
      refresh: 'Atualizar',
      ...
      language: 'Linguagem',
      source: 'Fonte Python',
      sourceHint: 'Monaco edita somente a fonte do draft canônico. O Working só muda depois de Preview / Apply / CAS.',
      ...
      validation: {
        ...
        tagReference: 'TAG alterada exige uma referência canônica por TagId.',
        tagReferenceUnexpected: 'Referência de TAG só pode ser usada no evento TAG alterada.',
        tagSelector: 'O seletor de TAG deve ser um bit canônico com índice inteiro não negativo.',
