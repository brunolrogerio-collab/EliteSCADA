...
{
    [Fact]
    public void SchemaV12WithoutVisualAssets_ParsesAsEmptyAssetCollectionAndReExportsAsCurrentSchema()
    {
        ...
        Assert.Equal(14, EngineeringExchangeService.CurrentSchemaVersion);
